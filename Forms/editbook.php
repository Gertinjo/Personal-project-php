  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="book Name" name="book_name" value="<?php echo  $user_data['Book_name'] ?>">
          <label for="floatingInput">book Name</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="book Description" name="description" value="<?php echo  $user_data['description'] ?>">
          <label for="floatingInput">book Description</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="book Price" name="Price" value="<?php echo  $user_data['Price'] ?>">
          <label for="floatingInput">book Quality</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="book Rating" name="rating" value="<?php echo  $user_data['rating'] ?>">
          <label for="floatingInput">book Rating</label>
        </div>
        <br>
